      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="max-w-6xl mx-auto flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
          ...
          <div className="flex-1 text-center lg:text-left">
            ...
            <p className="text-base md:text-lg text-muted-foreground/80 max-w-2xl mx-auto lg:mx-0 mb-10 leading-relaxed animate-fade-in-up opacity-0 stagger-3">
            ...
            {/* CTA Buttons */}
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 mb-12 animate-fade-in-up opacity-0 stagger-4">
            ...
            <div className="flex items-center justify-center lg:justify-start gap-4 animate-fade-in-up opacity-0 stagger-5">
              <a href="https://github.com/sandeep241003" target="_blank" rel="noopener noreferrer" className="p-3 rounded-lg glass hover:bg-primary/10 hover:border-primary/50 transition-all duration-300" aria-label="GitHub">
                <Github size={20} />
              </a>
              <a href="https://www.linkedin.com/in/sandeep-sharma24103/" target="_blank" rel="noopener noreferrer" className="p-3 rounded-lg glass hover:bg-primary/10 hover:border-primary/50 transition-all duration-300" aria-label="LinkedIn">
                <Linkedin size={20} />
              </a>
              <a href="mailto:sandeeps24103@gmail.com" className="p-3 rounded-lg glass hover:bg-primary/10 hover:border-primary/50 transition-all duration-300" aria-label="Email">
                <Mail size={20} />
              </a>
            </div>
          </div>
          ...
          {/* Right: Photo */}
          <div className="flex-shrink-0 animate-fade-in-up opacity-0 stagger-3">
            <div className="w-64 h-64 md:w-80 md:h-80 lg:w-96 lg:h-96 rounded-2xl overflow-hidden border-2 border-primary/20 shadow-glow">
